...
public class TabLayout extends HorizontalScrollView {
    ...
    private void ensureScrollAnimator() {
        if (this.scrollAnimator == null) {
            ...
            this.scrollAnimator.addUpdateListener(new AnonymousClass1());
        }
    }
    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        public void animateIndicatorToPosition(int i, int i2) {
            ...
            if (i3 != left || i4 != right) {
                ...
                valueAnimator2.addUpdateListener(new AnonymousClass1(i3, left, i4, right));
                valueAnimator2.addListener(new AnonymousClass2(i));
        ...
        public class AnonymousClass1 implements ValueAnimator.AnimatorUpdateListener {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                SlidingTabIndicator.this.setIndicatorPosition(AnimationUtils.lerp(this.val$startLeft, this.val$finalTargetLeft, animatedFraction), AnimationUtils.lerp(this.val$startRight, this.val$finalTargetRight, animatedFraction));
            }
        }
