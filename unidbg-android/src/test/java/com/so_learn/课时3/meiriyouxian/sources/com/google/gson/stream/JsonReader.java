...
public class JsonReader implements Closeable {
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            this.peekedString = nextQuotedValue(i == 8 ? DateFormat.QUOTE : '\"');
        } else if (i == 10) {
    ...
    private java.lang.String nextUnquotedValue() throws java.io.IOException {
        ...
        L_0x0096:
            ...
            r6.pos = r2
            return r1
            switch-data {91->0x005d, 92->0x004b, 93->0x005d, }
        */
    ...
    private void skipUnquotedValue() throws java.io.IOException {
        ...
        L_0x0051:
            ...
            return
            switch-data {91->0x004b, 92->0x0048, 93->0x004b, }
        */
    ...
    private boolean fillBuffer(int i) throws IOException {
        ...
        do {
            ...
            this.limit += read;
            if (this.lineNumber == 0 && (i2 = this.lineStart) == 0 && this.limit > 0 && cArr[0] == '\ufeff') {
                this.pos++;
                this.lineStart = i2 + 1;
                i++;
            }
