...
public final class ObservableRetryWhen<T> extends a<T, T> {
    final h<? super q<Throwable>, ? extends t<?>> b;

    public ObservableRetryWhen(t<T> tVar, h<? super q<Throwable>, ? extends t<?>> hVar) {
        super(tVar);
        this.b = hVar;
    }
    ...
    static final class RepeatWhenObserver<T> extends AtomicInteger implements io.reactivex.disposables.b, v<T> {
        ...
        final b<Throwable> signaller;
        final t<T> source;
        final AtomicReference<io.reactivex.disposables.b> upstream = new AtomicReference<>();
        final AtomicInteger wip = new AtomicInteger();

        RepeatWhenObserver(v<? super T> vVar, b<Throwable> bVar, t<T> tVar) {
