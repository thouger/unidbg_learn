...
public class VideoObject extends BaseMediaObject {
    public static final Parcelable.Creator<VideoObject> CREATOR = new AnonymousClass1();
    ...
    /* renamed from: com.sina.weibo.sdk.api.VideoObject$1  reason: invalid class name */
    class AnonymousClass1 implements Parcelable.Creator<VideoObject> {
        AnonymousClass1() {
        }
    ...
    public boolean checkArgs() {
        ...
        if (str == null || str.length() <= 512) {
            ...
            if (str2 != null && str2.length() > 512) {
                d.c("Weibo.VideoObject", "checkArgs fail, dataHdUrl is invalid");
                return false;
            } else if (this.duration > 0) {
                return true;
            } else {
                d.c("Weibo.VideoObject", "checkArgs fail, duration is invalid");
                return false;
            }
        } else {
            d.c("Weibo.VideoObject", "checkArgs fail, dataUrl is invalid");
            return false;
        }
    }
