...
/* compiled from: RobotTemplateMessageHolder3 */
public class h extends MessageHolderBase {
    ...
    public h(Context context, View view) {
        super(context, view);
        this.b = (TextView) view.findViewById(q.a(context, "id", "sobot_template3_msg"));
    ...
    public void a(int i, int i2) {
        if (this.i == null) {
            this.i = new a.C0145a().b(i, i2).c(0).a(5, 10, 5, 10).a(10).a(17301609, 17301611).b(17).d(40).a(true).e(5).f(r.a(this.h, 100.0f)).a();
    ...
    /* renamed from: com.sobot.chat.viewHolder.h$1  reason: invalid class name */
    public class AnonymousClass1 implements b {
        ...
        public RecyclerView.ViewHolder a(ViewGroup viewGroup, int i) {
            return new a(LayoutInflater.from(viewGroup.getContext()).inflate(q.a(viewGroup.getContext(), "sobot_chat_msg_item_template3_item_l"), viewGroup, false), viewGroup.getContext());
        }

        @Override // com.sobot.chat.widget.horizontalgridpage.b
        public void a(RecyclerView.ViewHolder viewHolder, int i) {
            Map map = (Map) h.this.f.a().get(i);
            if (!TextUtils.isEmpty((CharSequence) map.get("thumbnail"))) {
                a aVar = (a) viewHolder;
                aVar.b.setVisibility(0);
                aVar.d.setMaxLines(2);
                aVar.d.setEllipsize(TextUtils.TruncateAt.END);
                t.a(h.this.h, (String) map.get("thumbnail"), aVar.b, q.e(h.this.h, "sobot_bg_default_pic_img"), q.e(h.this.h, "sobot_bg_default_pic_img"));
            } else {
        ...
        public void a(View view, int i) {
            String b = s.b(h.this.h, "lastCid", "");
            if (h.this.f.b().getSugguestionsFontColor() == 0 && !TextUtils.isEmpty(h.this.f.b().getCid()) && b.equals(h.this.f.b().getCid())) {
                if (h.this.f.b().getAnswer().getMultiDiaRespInfo().getClickFlag() != 0 || h.this.f.b().getClickCount() <= 0) {
                    h.this.f.b().addClickCount();
                    SobotMultiDiaRespInfo multiDiaRespInfo = h.this.f.b().getAnswer().getMultiDiaRespInfo();
                    Map map = (Map) h.this.f.a().get(i);
                    if (h.this.h != null && multiDiaRespInfo != null && map != null) {
                        if (!multiDiaRespInfo.getEndFlag() || TextUtils.isEmpty((CharSequence) map.get("anchor"))) {
                            c.a(h.this.h, multiDiaRespInfo, map, h.this.p);
                        } else if (y.b == null || !y.b.a((String) map.get("anchor"))) {
                            Intent intent = new Intent(h.this.h, WebViewActivity.class);
    ...
    public void b() {
        ...
        this.d.setOnClickListener(new RobotTemplateMessageHolder3$2(this));
    }
    ...
    public void d() {
        ...
        this.C.setOnClickListener(new RobotTemplateMessageHolder3$3(this));
        this.D.setOnClickListener(new RobotTemplateMessageHolder3$4(this));
    }
