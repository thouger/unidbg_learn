    ...
    public static InsideNotificationItem a(String str) {
        ...
        try {
            ...
            if (jSONArray.length() > 11) {
                insideNotificationItem.setParams(k.a(new JSONObject(jSONArray.getString(11))));
            }
