...
public class ProductsEntity implements BaseSubscibe, BaseTitle, Serializable {
    ...
    private boolean isSkeletonData;
    ...
    private PromotionDeliveryTag markdownTag;
    ...
    private ProductTagInfoBean tagInfo;
    private String tags;
    ...
    public int getSkuType() {
        AppMethodBeat.i(6425, false);
        int i = b.a(this.markDown) ? 1 : 2;
        AppMethodBeat.o(6425);
        return i;
    }

    public int getSkuTypeBuyTag() {
        return this.markdownTag == null ? 1 : 2;
    }
    ...
    public PromotionDeliveryTag getMarkdownTag() {
        return this.markdownTag;
    }

    public void setMarkdownTag(PromotionDeliveryTag promotionDeliveryTag) {
        this.markdownTag = promotionDeliveryTag;
    }
    ...
    public boolean isSpu() {
        boolean z = false;
        AppMethodBeat.i(6579, false);
        SpuInfoBean spuInfoBean = this.spuInfo;
        if (spuInfoBean != null && !b.a(spuInfoBean.skuInfo)) {
            z = true;
        }
    ...
    public int getPositionInRecommend() {
        return this.positionInRecmooend;
    }

    public void setPositionInRecommend(int i) {
        this.positionInRecmooend = i;
    }

    public ProductTagInfoBean getTagInfo() {
        return this.tagInfo;
    }

    public void setTagInfo(ProductTagInfoBean productTagInfoBean) {
        this.tagInfo = productTagInfoBean;
    }
    ...
    public void setSkeletonData(boolean z) {
