...
public final class ObservableFlatMapMaybe<T, R> extends a<T, R> {
    ...
    static final class FlatMapMaybeObserver<T, R> extends AtomicInteger implements b, v<T> {
        ...
        FlatMapMaybeObserver(v<? super R> vVar, h<? super T, ? extends o<? extends R>> hVar, boolean z) {
        ...
        final class InnerObserver extends AtomicReference<b> implements b, m<R> {
