...
/* compiled from: RobotTemplateMessageHolder6 */
public class k extends MessageHolderBase {
    ...
    public k(Context context, View view) {
        super(context, view);
        this.c = (TextView) view.findViewById(q.a(context, "id", "sobot_template6_msg"));
        this.b = (TextView) view.findViewById(q.a(context, "id", "sobot_template6_title"));
        ...
        if (!(zhiChiMessageBase.getAnswer() == null || zhiChiMessageBase.getAnswer().getMultiDiaRespInfo() == null)) {
            ...
            if (!"000000".equals(multiDiaRespInfo.getRetCode()) || interfaceRetList == null || interfaceRetList.size() <= 0) {
                ...
                if (map != null && map.size() > 0) {
                    k();
                    j.a(context).a(this.b, map.get("tempStr").replace("<div>", "").replace("</div>", "").replace("<p>", "").replace("</p>", "<br/>"), i());
                }
            }
        }
        c();
    ...
    public void b() {
        ...
        this.d.setOnClickListener(new RobotTemplateMessageHolder6$1(this));
    }
    ...
    public void d() {
        ...
        this.C.setOnClickListener(new RobotTemplateMessageHolder6$2(this));
        this.D.setOnClickListener(new RobotTemplateMessageHolder6$3(this));
    }
