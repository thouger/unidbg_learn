...
public final class MaybeTimeoutMaybe<T, U> extends a<T, T> {
    ...
    static final class TimeoutMainMaybeObserver<T, U> extends AtomicReference<b> implements b, m<T> {
    ...
    static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<b> implements m<Object> {
