...
public final class ObservableConcatMapMaybe<T, R> extends q<R> {
    ...
    static final class ConcatMapMaybeMainObserver<T, R> extends AtomicInteger implements b, v<T> {
        ...
        ConcatMapMaybeMainObserver(v<? super R> vVar, h<? super T, ? extends o<? extends R>> hVar, int i, ErrorMode errorMode) {
