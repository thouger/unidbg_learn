...
public final class FlutterActivityDelegate implements FlutterActivityEvents, PluginRegistry, FlutterView.Provider {
    ...
    private void addLaunchView() {
        ...
        if (view != null) {
            ...
            this.flutterView.addFirstFrameListener(new AnonymousClass1());
    ...
    public class AnonymousClass1 implements FlutterView.FirstFrameListener {
        ...
        public void onFirstFrame() {
            FlutterActivityDelegate.this.launchView.animate().alpha(0.0f).setListener(new AnonymousClass1());
            FlutterActivityDelegate.this.flutterView.removeFirstFrameListener(this);
        }

        /* renamed from: io.flutter.app.FlutterActivityDelegate$1$1  reason: invalid class name */
