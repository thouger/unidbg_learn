...
public class Sign6 extends AbstractJni implements IOResolver {
    ...
    private Sign6() {
        ...
        DalvikModule dm = vm.loadLibrary(new File("unidbg-android/src/test/java/com/so_learn/Sign6/libmetasec_ml.so"), true);
        module = dm.getModule();
    ...
    public FileResult resolve(Emulator emulator, String pathname, int oflags) {
        if(pathname.equals("/proc/self/exe")){
            return FileResult.success(new SimpleFileIO(oflags, new File("unidbg-android/src/test/java/com/so_learn/Sign6/exe"), pathname));
        }
        return null;
    }
}