...
public class AntiOllvm {
    ...
    private static final String inName = "unidbg-android/src/test/resources/libtprt2.so";
    private static final String outName = "unidbg-android/src/test/resources/libtprt3.so";
...
//        vm.loadLibrary(new File("unidbg-android/src/main/resources/android/sdk23/lib64/libc.so"),false);
//        vm.loadLibrary(new File("unidbg-android/src/main/resources/android/sdk23/lib64/libm.so"),false);
//        vm.loadLibrary(new File("unidbg-android/src/main/resources/android/sdk23/lib64/libdl.so"),false);
//        vm.loadLibrary(new File("unidbg-android/src/test/resources/system/libstdc++.so"),false);
//        vm.loadLibrary(new File("unidbg-android/src/test/resources/system/ld-android.so"),false);
...
//        ao.reorderblock();
    ...
    public void do_processflt()
    {
        ...
        // 需要用 libtprt2.so，判断 b.eq 和一直往上找直到找到cmp w8为止
